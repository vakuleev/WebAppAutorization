...
namespace WebAppAutorization.Data.Migrations
{
    ...
    [Migration("20231006053747_ISData_ED")]
    partial class ISData_ED
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.H_Division", b =>
                {
                    ...
                    b.ToTable("H_Division", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.H_Factory", b =>
                {
                    ...
                    b.ToTable("H_Factory", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.H_object", b =>
                {
                    ...
                    b.ToTable("H_object", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.I_Division_eemp", b =>
                {
                    ...
                    b.ToTable("I_Division_eemp", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.I_Factory_Division", b =>
                {
                    ...
                    b.ToTable("I_Factory_Division", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.I_Factory_eemp", b =>
                {
                    ...
                    b.ToTable("I_Factory_eemp", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.I_division_object", b =>
                {
                    ...
                    b.ToTable("I_division_object", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.ISData.I_object_eemp", b =>
                {
                    ...
                    b.HasIndex("H_Factorysid_factory");

                    b.HasIndex("id_eemp");

                    b.ToTable("I_object_eemp", (string)null);
                });
            ...
            modelBuilder.Entity("WebAppAutorization.Data.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b6f390d9-7e5d-4c80-8349-e8e4abf41860",
                            CurrentCompanyId = 0L,
                            DateFiltrEnd = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2304),
                            DateFiltrStart = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2288),
                            ...
                            SecurityStamp = "91ad6020-2ed7-4a63-af8a-02cdd0ca672c",
                            SoftDelete = true,
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ca9be208-eb50-4eb3-a34a-253b06b078bb",
                            CurrentCompanyId = 0L,
                            DateFiltrEnd = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2325),
                            DateFiltrStart = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2324),
                            Email = "s.isaev@ao-gns.ru",
                            EmailConfirmed = true,
                            FamilyName = "Исаев",
                            FirstName = "Сергей",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9e99fab9-4096-436f-938c-05fd449f7ed2",
                            SoftDelete = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "3",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "96a3f9f3-8f1e-4ee0-a103-c290e0c479b5",
                            CurrentCompanyId = 0L,
                            DateFiltrEnd = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2343),
                            DateFiltrStart = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2343),
                            ...
                            PhoneNumber = "",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "322e530c-17f4-4e77-83a0-cbd0d21490ea",
                            SoftDelete = true,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "5",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6b2f6189-5fe5-4d7c-98d3-8f3cace96a6e",
                            CurrentCompanyId = 0L,
                            DateFiltrEnd = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2350),
                            DateFiltrStart = new DateTime(2023, 10, 6, 12, 37, 39, 138, DateTimeKind.Local).AddTicks(2350),
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "efe27a4b-8544-4040-b80a-eb6718d1c464",
                            SoftDelete = true,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("WebAppAutorization.Data.Tables.Sheetf", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Approved = false,
                            DateAct = new DateTime(2023, 10, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Delete = false,
                            DocType = "D",
