...
namespace WebAppAutorization.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessage = "Символов {0} должно быть не менее {2} и не более {1} символов.", MinimumLength = 3)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", "Код подтверждения недействителен.");
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            _logger.LogInformation("Пользователь с ID '{UserId}' включил 2FA с помощью приложения для проверки подлинности.", userId);
