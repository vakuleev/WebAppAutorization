...
namespace WebAppAutorization.Pages.SandSludgePools
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IList<SandSludgePool> SandSludgePools { get; set; } = default!;
               ...
               WebAppAutorization.Data.gnsDbContext context)
        {
            ...
            curUser = new User();
            SandSludgePools = new List<SandSludgePool>();
        }
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.SandSludgePools != null)
            {
                //IzvestFromSilos = await _context.IzvestFromSilos.OrderBy(s => s.DateTimeTrial).ToListAsync();
                SandSludgePools = await _context.SandSludgePools.Where(
